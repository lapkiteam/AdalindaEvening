...
runTest(
  ...
  [
    ...
    "/act 1  ", // взять огурец №1
    "/act 2  ", // взять огурец №2
    "/way    ",
    "/go 4   ", // назад
    "/inv    ",
...
runTest(
  ...
  [
    ...
    "/inv    ",
    "/use 7 2", // яйца в тазик
    "/inv    ",
    "/use 7 2", // майонез — в тазик
    ...
    "/go 1   ", // назад
    "/inv    ",
    "/use 7 2", // горошек — в тазик
    "/inv    ",
    "/use 7 2", // картошку — в тазик
    "/act 2  ", // взять салатик
    "/way    ",
    "/go 5   ", // в зал
    "/act 2  ", // отодвинуть диванчик
    "/inv    ",
    "/use 5 3", // салатик — место под салатик
    "/act 2  ", // задвинуть диванчик
    "/act 2  ", // сесть на диванчик
    "/way    ",
    "/go 4   ", // в прихожую
    "/inv    ",
    "/use 2 1", // огуречные нунчаки — на бывшего
    "/act 1  ", // осмотреть огуречные нунчаки
    "/way    ",
    "/go 3   ", // в зал
    "/act 2  ", // сесть на диванчик
  ],
